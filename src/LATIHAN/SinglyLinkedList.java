...
public class SinglyLinkedList {
 protected ClassNode first;
 protected ClassNode last;
 public int size;
 /* Constructor */
 ...
 //buat satu node baru
 ClassNode nptr = new ClassNode(val, null);
